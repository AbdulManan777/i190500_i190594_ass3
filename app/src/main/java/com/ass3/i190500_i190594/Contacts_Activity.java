...
public class Contacts_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // setting user name on profile xml file
        userName.setText(username);

        // Recycler view for keeping chats rows
        ...
        StringRequest request2=new StringRequest(Request.Method.POST, "http://"+IP_server.getIP_server()+"/smdass3/getImageOnly.php",
                        ...
                        try {
                            ...
                            if(obj.getInt("code")==1)
                            {
                                ...
                                for (int i=0; i<contacts.length();i++)
                                {
                                    ...
                                    url2="http://"+IP_server.getIP_server()+"/smdass3/images/"+image;
